<x-app-layout>
                                            ...
                                            <div class="product__prices-stock">
                                                <div class="product__prices">
                                                    <div class="product__price product__price--current">
                                                        Rs.{{ number_format($product->price, 2, '.', ',' ) }}</div>
                                                    ...
                                                    <div class="status-badge__body">
                                                        ...
                                                        @else
                                                            <div class="status-badge__text"
                                                                 style="color: red; background-color: #ffe5e5; border-radius: 10px">
                                                                Out of Stock
                                                            </div>
                                                        @endif
                                                        <div class="status-badge__tooltip" tabindex="0"
	...
	c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-2.5v-1.7H28c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-0.9v-1.7L29.6,21.9L29.6,21.9z"/>
                                                ...
                                                <div class="shop-features__info">
                                                    ...
                                                    <div class="shop-features__item-subtitle">For orders from Rs.5,000
                                                    </div>
                                                </div>
                                            </li>
	...
	s0.4-0.1,0.5-0.2l1.8-1.8l5.3,5.3c0.2,0.2,0.4,0.2,0.5,0.2c0.2,0,0.4-0.1,0.5-0.2c0.3-0.3,0.3-0.8,0-1.1L27.4,15.8z"/>
                                                ...
                                                <div class="shop-features__info">
                                                    ...
                                                    <div class="shop-features__item-subtitle">Discounts up to 30%
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="shop-features__divider" role="presentation"></li>
