<x-app-layout>
                        ...
                        <div class="product product--layout--full">
                            <div class="product__body">
                                ...
                                <div class="product-gallery product-gallery--layout--product-full product__gallery"
                                    ...
                                    <div class="product-gallery__featured"><button type="button"
                                            class="product-gallery__zoom"><svg width="24" height="24">
 ...
 c-3.9,0-7,3.1-7,7s3.1,7,7,7s7-3.1,7-7S18.9,2,15,2z M16,13h-2v-3h-3V8h3V5h2v3h3v2h-3V13z" />
                ...
                --> <a class="image image--type--product" href="images/products/product-2-700x700.jpg" target="_blank"
                                                ...
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-2-500x500.jpg" alt="">
                                                </div>
                                            </a><!--
                The data-width and data-height attributes must contain the size of a larger version
                of the product image.
                ...
                --> <a class="image image--type--product" href="images/products/product-1-700x700.jpg" target="_blank"
                                                data-width="700" data-height="700">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-1-500x500.jpg" alt="">
                                                </div>
                                            </a><!--
                The data-width and data-height attributes must contain the size of a larger version
                of the product image.
                ...
                --> <a class="image image--type--product" href="images/products/product-3-700x700.jpg" target="_blank"
                                                data-width="700" data-height="700">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-3-500x500.jpg" alt="">
                                                </div>
                                            </a><!--
                The data-width and data-height attributes must contain the size of a larger version
                of the product image.
                ...
                --> <a class="image image--type--product" href="images/products/product-4-700x700.jpg" target="_blank"
                                                data-width="700" data-height="700">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-4-500x500.jpg" alt="">
                                                </div>
                                            </a></div>
                                    </div>
                                    <div class="product-gallery__thumbnails">
                                        <div class="owl-carousel">
                                            <div class="product-gallery__thumbnails-item image image--type--product">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-2-70x70.jpg" alt=""></div>
                                            </div>
                                            <div class="product-gallery__thumbnails-item image image--type--product">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-1-70x70.jpg" alt=""></div>
                                            </div>
                                            <div class="product-gallery__thumbnails-item image image--type--product">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-3-70x70.jpg" alt=""></div>
                                            </div>
                                            <div class="product-gallery__thumbnails-item image image--type--product">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-4-70x70.jpg" alt=""></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="product__header">
                                    ...
                                    <div class="product__subtitle">
                                        {{-- <div class="product__rating">
                                            ...
                                            <div class="product__rating-label"><a href="#">3.5 on 7 reviews</a>
                                            </div>
                                        </div> --}}
                                        <div
                                ...
                                <div class="product__main">
                                    <div class="product__excerpt">Many philosophical debates that began in ancient
                                        times are still debated today. In one general sense, philosophy is
                                    ...
                                    <div class="product__features">
                                        ...
                                        {{-- <div class="product__features-link"><a href="#">See Full
                                                Specification</a>
                                        </div> --}}
                                    </div>
                                </div>
                                    ...
                                    <div class="product__info-card">
                                        <div class="product__info-body">
                                            ...
                                            <div class="product__prices-stock">
                                                <div class="product__prices">
                                                    <div class="product__price product__price--current">$1,499.00
                                                    </div>
                                                </div>
                                                <div
                                                ...
                                                <div class="product-form__row">
                                                    ...
                                                    <div class="product-form__control">
                                                        <div class="input-radio-label">
                                                            <div class="input-radio-label__list"><label
                                                                    class="input-radio-label__item"><input
                                                                        type="radio" name="material"
                                                                        class="input-radio-label__input"> <span
                                                                        class="input-radio-label__title">Steel</span></label>
                                                                <label class="input-radio-label__item"><input
                                                                        type="radio" name="material"
                                                                        class="input-radio-label__input"> <span
                                        ...
                                        <div class="product__actions">
                                            ...
                                            <div class="product__actions-item product__actions-item--addtocart">
                                                <button class="btn btn-primary btn-lg btn-block">Add to
                                                    cart</button>
                                            </div>
 ...
 l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product__tags-and-share-links">
                                            <div class="product__tags tags tags--sm">
                                                <div class="tags__list"><a href="#">Brake Kit</a> <a
                                                        href="#">Brandix</a> <a href="#">Filter</a> <a
                                                        href="#">Bumper</a> <a href="#">Transmission</a>
                                                    <a href="#">Hood</a></div>
                                            </div>
                                    ...
                                    <div class="product__shop-features shop-features">
                                        <ul class="shop-features__list">
                                            <li class="shop-features__item">
                                                <div class="shop-features__item-icon"><svg width="48"
 ...
 c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-2.5v-1.7H28c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-0.9v-1.7L29.6,21.9L29.6,21.9z" />
                                                ...
                                                <div class="shop-features__info">
                                                    ...
                                                    <div class="shop-features__item-subtitle">For orders from $50
                                                    </div>
                                                </div>
                                            </li>
 ...
 S40.1,35.1,40.3,35.1z" />
                                                ...
                                                <div class="shop-features__info">
                                                    ...
                                                    <div class="shop-features__item-subtitle">Only secure payments
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="shop-features__divider" role="presentation"></li>
 ...
 s0.4-0.1,0.5-0.2l1.8-1.8l5.3,5.3c0.2,0.2,0.4,0.2,0.5,0.2c0.2,0,0.4-0.1,0.5-0.2c0.3-0.3,0.3-0.8,0-1.1L27.4,15.8z" />
                                                ...
                                                <div class="shop-features__info">
                                                    ...
                                                    <div class="shop-features__item-subtitle">Discounts up to 90%
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="shop-features__divider" role="presentation"></li>
                                ...
                                <div class="product__tabs product-tabs product-tabs--layout--full">
                                    <ul class="product-tabs__list">
                                        ...
                                        {{-- <li class="product-tabs__item"><a
                                                href="#product-tab-specification">Specification</a></li> --}}
                                        {{-- <li class="product-tabs__item"><a href="#product-tab-reviews">Reviews <span
                                                    class="product-tabs__item-counter">3</span></a></li> --}}
                                        {{-- <li class="product-tabs__item"><a href="#product-tab-analogs">Analogs</a>
                                        </li> --}}
                                    </ul>
                                    <div class="product-tabs__content">
                                        <div class="product-tabs__pane product-tabs__pane--active"
                                            ...
                                            <div class="typography">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
                                                    ...
                                                    rutrum dolor tristique id. Quisque pellentesque ullamcorper
                                                    felis, eget gravida mi elementum a. Maecenas consectetur
                                                    volutpat ante, sit amet molestie urna luctus in. Nulla eget
                                                    dolor semper urna malesuada dictum. Duis eleifend pellentesque
                                                    dui et finibus. Pellentesque dapibus dignissim augue. Etiam odio
                                                    est, sodales ac aliquam id, iaculis eget lacus. Aenean porta,
                                                    ante vitae suscipit pulvinar, purus dui interdum tellus, sed
                                                    dapibus mi mauris vitae tellus.</p>
                                                <h4>Etiam lacus lacus mollis in mattis</h4>
                                                <p>Praesent mattis eget augue ac elementum. Maecenas vel ante ut
                                                    enim mollis accumsan. Vestibulum vel eros at mi suscipit
                                                    feugiat. Sed tortor purus, vulputate et eros a, rhoncus laoreet
                                                    orci. Proin sapien neque, commodo at porta in, vehicula eu elit.
                                                    Vestibulum ante ipsum primis in faucibus orci luctus et ultrices
                                                    posuere cubilia Curae; Curabitur porta vulputate augue, at
                                                    sollicitudin nisl molestie eget.</p>
                                                <p>Nunc sollicitudin, nunc id accumsan semper, libero nunc aliquet
                                                    nulla, nec pretium ipsum risus ac neque. Morbi eu facilisis
                                                    purus. Quisque mi tortor, cursus in nulla ut, laoreet commodo
                                                    quam. Pellentesque et ornare sapien. In ac est tempus urna
                                                    tincidunt finibus. Integer erat ipsum, tristique ac lobortis sit
                                                    amet, dapibus sit amet purus. Nam sed lorem nisi. Vestibulum
                                                    ultrices tincidunt turpis, sit amet fringilla odio scelerisque
                                                    non.</p>
                                            </div>
                                        </div>
                                        {{-- <div class="product-tabs__pane" id="product-tab-specification">
                                            <div class="spec">
                                                ...
                                                <div class="spec__disclaimer">Information on technical
                                                    characteristics, the delivery set, the country of manufacture
                                                    and the appearance of the goods is for reference only and is
                                                                ...
                                                                <div class="review">
                                                                    <div class="review__body">
                                                                        ...
                                                                        <div class="review__meta">
                                                                            <div class="review__author">Samantha
                                                                                Smith</div>
                                                                            <div class="review__date">27 May, 2018
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="review__content typography">
                                                                            ...
                                                                            nisi, imperdiet vitae sodales in,
                                                                            maximus ut lectus. Vivamus commodo
                                                                ...
                                                                <div class="review">
                                                                    <div class="review__body">
                                                                        <div class="review__avatar"><img
                                                                                ...
                                                                                alt=""></div>
                                                                        <div class="review__meta">
                                                                            <div class="review__author">Adam Taylor
                                                                            </div>
                                                                            <div class="review__date">12 April, 2018
                                                                            </div>
                                                                        </div>
                                                                        <div class="review__rating">
                                                                            <div class="rating">
                                                                        ...
                                                                        <div class="review__content typography">
                                                                            ...
                                                                            Nulla ut ex mollis, volutpat tellus
                                                                ...
                                                                <div class="review">
                                                                    <div class="review__body">
                                                                        <div class="review__avatar"><img
                                                                                ...
                                                                                alt=""></div>
                                                                        <div class="review__meta">
                                                                            <div class="review__author">Helena
                                                                                Garcia</div>
                                                                            <div class="review__date">2 January,
                                                                                2018</div>
                                                                        </div>
                                                                        <div class="review__rating">
                                                                            <div class="rating">
                                                                        ...
                                                                        <div class="review__content typography">Duis
                                                                            ac lectus scelerisque quam blandit
                                                                            egestas. Pellentesque hendrerit eros
                                                                            laoreet suscipit ultrices.</div>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        </ol>
                                                        ...
                                                        <div class="col-xxl-8 col-xl-10 col-lg-9 col-12">
                                                            <div class="form-row">
                                                                <div class="form-group col-md-4"><label
                                                                        for="review-stars">Review Stars</label>
                                                                ...
                                                                <div class="form-group col-md-4"><label
                                                                        for="review-author">Your Name</label> <input
                                                                        type="text" class="form-control"
                                                                        id="review-author" placeholder="Your Name">
                                                                </div>
                                                                <div class="form-group col-md-4"><label
                                                                        for="review-email">Email Address</label>
                                                            ...
                                                            <div class="form-group mb-0 mt-4"><button type="submit"
                                                                    class="btn btn-primary">Post Your
                                                                    Review</button></div>
                                                        </div>
                                                    </div>
                                                </form>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="analogs-table__column analogs-table__column--name">
                                                            <a href="#"
                                                                class="analogs-table__product-name">Sunset
                                                                Brake Kit</a><br>
                                                        ...
                                                        <td
                                                            ...
                                                            <div class="analogs-table__rating">
                                                                ...
                                                                <div class="analogs-table__rating-label">10 Reviews
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="analogs-table__column analogs-table__column--vendor"
                                                            data-title="Vendor">Sunset<div
                                                    ...
                                                    <tr>
                                                        <td class="analogs-table__column analogs-table__column--name">
                                                            <a href="#"
                                                                class="analogs-table__product-name">Specter
                                                                Brake Kit</a><br>
                                                            <div class="analogs-table__sku" data-title="SKU">
                                                                SCT-123A380-S</div>
                                                        </td>
                                                        <td
                                                            ...
                                                            <div class="analogs-table__rating">
                                                                ...
                                                                <div class="analogs-table__rating-label">34 Reviews
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="analogs-table__column analogs-table__column--vendor"
                                                            data-title="Vendor">Specter<div
                                                    ...
                                                    <tr>
                                                        <td class="analogs-table__column analogs-table__column--name">
                                                            <a href="#"
                                                                class="analogs-table__product-name">Brake
                                                                Kit</a><br>
                                                            <div class="analogs-table__sku" data-title="SKU">
                                                                NNO-120K643-S</div>
                                                        </td>
                                                        <td
                                                            ...
                                                            <div class="analogs-table__rating">
                                                                ...
                                                                <div class="analogs-table__rating-label">7 Reviews
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="analogs-table__column analogs-table__column--vendor"
                                                            data-title="Vendor">No Name<div
                                                                class="analogs-table__country">(China)</div>
                                                        </td>
                                                        <td class="analogs-table__column analogs-table__column--price">
                                                            $569.00</td>
                                            ...
                                            <div class="block-products-carousel__cell">
                                                <div class="product-card product-card--layout--grid">
                                                    <div class="product-card__actions-list"><button
                                                            ...
                                                            type="button" aria-label="Quick view"><svg
                                                                width="16" height="16">
 ...
 l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                                    ...
                                                    <div class="product-card__image">
                                                        <div class="image image--type--product"><a
                                                                href="product-full.html" class="image__body"><img
                                                                    class="image__tag"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="status-badge__body">
                                                                ...
                                                                <div class="status-badge__text">Part Fit for 2011
                                                                    Ford Focus S</div>
                                                                <div class="status-badge__tooltip" tabindex="0"
                                                                    data-toggle="tooltip"
                                                                    title="Part&#x20;Fit&#x20;for&#x20;2011&#x20;Ford&#x20;Focus&#x20;S">
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__meta"><span
                                                                class="product-card__meta-title">SKU:</span>
                                                            140-10440-B</div>
                                                        <div class="product-card__name">
                                                            <div>
                                                                ...
                                                                </div><a href="product-full.html">Brandix Spark Plug
                                                                    Kit ASR-400</a>
                                                            </div>
                                                        </div>
                                                        <div class="product-card__rating">
                                                            ...
                                                            <div class="product-card__rating-label">4 on 3 reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="product-card__info">
                                                        ...
                                                        <div class="product-card__name">
                                                            <div>
                                                                ...
                                                                </div><a href="product-full.html">Left Headlight Of
                                                                    Brandix Z54</a>
                                                            </div>
                                                        </div>
                                                        <div class="product-card__rating">
                                                            ...
                                                            <div class="product-card__rating-label">3 on 14 reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__footer">
                                                    ...
                                                    <div class="product-card__info">
                                                        ...
                                                        <div class="product-card__name">
                                                            <div>
                                                                <div class="product-card__badges">
                                                                    <div class="tag-badge tag-badge--hot">hot</div>
                                                                </div><a href="product-full.html">Glossy Gray 19"
                                                        ...
                                                        <div class="product-card__rating">
                                                            ...
                                                            <div class="product-card__rating-label">4 on 26 reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__footer">
 ...
 l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__meta"><span
                                                            ...
                                                            729-51203-B</div>
                                                        <div class="product-card__name">
                                                            <div><a href="product-full.html">Twin Exhaust Pipe From
                                                                    Brandix Z54</a></div>
                                                        </div>
                                                        <div class="product-card__rating">
                                                            <div class="rating product-card__rating-stars">
                                                            ...
                                                            <div class="product-card__rating-label">4 on 9 reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__footer">
 ...
 l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__meta"><span
                                                            ...
                                                            573-49386-C</div>
                                                        <div class="product-card__name">
                                                            <div><a href="product-full.html">Motor Oil Level 5</a>
                                                            </div>
                                                        </div>
                                                        <div class="product-card__rating">
                                                            <div class="rating product-card__rating-stars">
                                                            ...
                                                            <div class="product-card__rating-label">5 on 2 reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__footer">
 ...
 l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__meta"><span
                                                            ...
                                                            753-38573-B</div>
                                                        <div class="product-card__name">
                                                            <div><a href="product-full.html">Brandix Engine Block
                                                                    Z4</a></div>
                                                        </div>
                                                        <div class="product-card__rating">
                                                            <div class="rating product-card__rating-stars">
                                                            ...
                                                            <div class="product-card__rating-label">0 on 0 reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__footer">
 ...
 l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__meta"><span
                                                            ...
                                                            472-67382-Z</div>
                                                        <div class="product-card__name">
                                                            <div><a href="product-full.html">Brandix Clutch Discs
                                                                    Z175</a></div>
                                                        </div>
                                                        <div class="product-card__rating">
                                                            <div class="rating product-card__rating-stars">
                                                            ...
                                                            <div class="product-card__rating-label">3 on 7 reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__footer">
 ...
 l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__meta"><span
                                                            ...
                                                            855-78336-G</div>
                                                        <div class="product-card__name">
                                                            <div><a href="product-full.html">Brandix Manual Five
                                                                    Speed Gearbox</a></div>
                                                        </div>
                                                        <div class="product-card__rating">
                                                            <div class="rating product-card__rating-stars">
                                                            ...
                                                            <div class="product-card__rating-label">4 on 6 reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__footer">
 ...
 l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__meta"><span
                                                            ...
                                                            473-75662-R</div>
                                                        <div class="product-card__name">
                                                            <div><a href="product-full.html">Set of Car Floor Mats
                                                                    Brandix Z4</a></div>
                                                        </div>
                                                        <div class="product-card__rating">
                                                            <div class="rating product-card__rating-stars">
                                                            ...
                                                            <div class="product-card__rating-label">4 on 16 reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__footer">
