                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            <div>
                                                <p class="font-semibold">{{ $garageVehicle->year }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            <div>
                                                <p class="font-semibold">{{ $garageVehicle->brand }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            <div>
                                                <p class="font-semibold">{{ $garageVehicle->model }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            ...
                                            <form
                                                action="{{ route('garage.destroy', $garageVehicle->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button
