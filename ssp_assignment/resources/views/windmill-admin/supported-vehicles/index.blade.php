                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            >
                                {{--                                <th class="px-4 py-3">Garage Vehicles</th>--}}
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            <div>
                                                <p class="font-semibold">{{ $supportedVehicle->product->name }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            <div>
                                                <p class="font-semibold">{{ $supportedVehicle->year }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            <div>
                                                <p class="font-semibold">{{ $supportedVehicle->brand }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            <div>
                                                <p class="font-semibold">{{ $supportedVehicle->model }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            ...
                                            <form
                                                action="{{ route('supported-vehicles.destroy', $supportedVehicle->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button
