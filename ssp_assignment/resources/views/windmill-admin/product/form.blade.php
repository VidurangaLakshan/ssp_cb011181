                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        ...
                                        <input type="text" name="price" id="price" autocomplete="price" value="{{ old('price', $product->price) }}" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="12,000">
                                    </div>
                                </div>
                                @error('price')
                                <p class="mt-3 text-sm leading-6 text-red-600">
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        ...
                                        <input type="text" name="stock" id="stock" autocomplete="stock" value="{{ old('stock', $product->stock) }}" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="12,000">
                                    </div>
                                </div>
                                @error('stock')
                                <p class="mt-3 text-sm leading-6 text-red-600">
