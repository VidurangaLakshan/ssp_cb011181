...
<body>
 ...
 c-2.8,0-5.5-1.7-6.4-4C116.7,15.1,117.4,14,118.4,14z"></path>
                        ...
                        <div class="mobile-header__search mobile-search">
                            <form class="mobile-search__body"><input type="text" class="mobile-search__input"
                                    ...
                                    class="mobile-search__vehicle-picker" aria-label="Select Vehicle"><svg
                                        width="20" height="20">
            ...
            <div class="header">
                ...
                <div class="header__topbar-start">
                    <div class="topbar topbar--spaceship-start">
                        ...
                        <div class="topbar__item-text"><a class="topbar__link" href="#">Contacts</a>
                        </div>
                    ...
                    <div class="topbar topbar--spaceship-end">
                        ...
                        <div class="topbar__item-button topbar__menu"><button
                            ...
                            <div class="topbar__menu-body">
                                ...
                                <a class="topbar__menu-item" href="#">රු Lankan Rupee</a>
                            </div>
                        </div>
                        <div class="topbar__menu"><button
                                class="topbar__button topbar__button--has-arrow topbar__menu-button"
                                type="button"><span class="topbar__button-label">Language:</span> <span
                                ...
                                <div class="departments__body">
                                    <ul class="departments__list">
                                        ...
                                        <li
                                            ...
                                            <a href="#" class="departments__item-link">Headlights & Lighting
 ...
 C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                            ...
                                            <div class="departments__item-menu">
                                                <div
                                                    ...
                                                    <div class="megamenu__image"><img
                                                            src="images/departments/departments-2.jpg" alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-1of5">
                                                            <ul
                                        ...
                                        <li
                                            ...
                                            <a href="#" class="departments__item-link">Interior Parts <span
                                                    class="departments__item-arrow"><svg width="7"
                                                        height="11">
                                                        <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
 C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                                    </svg></span></a>
                                            <div class="departments__item-menu">
                                                <div
                                                    ...
                                                    <div class="megamenu__image"><img
                                                            src="images/departments/departments-1.jpg" alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-3">
                                                            <ul
 ...
 C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                            ...
                                            <div class="departments__item-menu">
                                                <div
                                                    ...
                                                    <div class="megamenu__image"><img
                                                            src="images/departments/departments-3.jpg" alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <ul
 ...
 C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                            ...
                                            <div class="departments__item-menu">
                                                <div
                                                    ...
                                                    <div class="megamenu__image"><img
                                                            src="images/departments/departments-4.jpg" alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <ul
 ...
 C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                        ...
                                        <li class="departments__item"><a href="#"
                                                class="departments__item-link">Fuel
                                                Systems</a></li>
                                        <li class="departments__item"><a href="#"
                                        ...
                                        <li class="departments__item"><a href="#"
                                                class="departments__item-link">Body
                                                Parts</a></li>
                                        <li class="departments__item"><a href="#"
                                                class="departments__item-link">Transmission</a></li>
                                        <li class="departments__item"><a href="#"
                                                class="departments__item-link">Air
                                                Filters</a></li>
                                        <li class="departments__list-padding" role="presentation"></li>
                                    </ul>
                        ...
                        <div class="main-menu">
                            <ul class="main-menu__list">
                                <li
                                    ...
                                    <a href="#" class="main-menu__link">Home <svg width="7px"
                                            height="5px">
                                            <path
                                                d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
                                        </svg></a>
          ...
          <ul class="menu">
           <li class="menu__item"><a href="index.html" class="menu__link">Home One</a>
           </li>
           <li class="menu__item"><a href="index2.html" class="menu__link">Home Two</a>
           </li>
             ...
             <ul class="menu">
              ...
              <li class="menu__item"><a href="mobile-header-variant-two.html"
                class="menu__link">Variant Two</a></li>
                                ...
                                <li
                                    class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                                    <a href="#" class="main-menu__link">Shop <svg width="7px"
                                            height="5px">
                                            <path
                                                d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
                                        </svg></a>
          ...
          <ul class="menu">
           ...
           <li class="menu__item"><a href="track-order.html" class="menu__link">Track
             Order</a></li>
                                ...
                                <li
                                    class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                                    <a href="#" class="main-menu__link">Blog <svg width="7px"
                                            height="5px">
                                            <path
                                                d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
                                        </svg></a>
          ...
          <ul class="menu">
           ...
           <li class="menu__item menu__item--has-submenu"><a
             href="#" class="menu__link">Post Page <span
           ...
           <li class="menu__item"><a href="post-without-image.html"
             class="menu__link">Post Without Image</a></li>
                                ...
                                <li
                                    class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                                    <a href="#" class="main-menu__link">Account <svg width="7px"
                                            height="5px">
                                            <path
                                                d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
                                        </svg></a>
         ...
         <a href="#" class="main-menu__link">Pages <svg width="7px" height="5px">
           <path
            d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
          </svg></a>
         <div class="main-menu__submenu">
                    ...
                    <div class="search">
                        <form action="#" class="search__body">
                            <div class="search__shadow"></div><input class="search__input" type="text"
                                placeholder="Enter Keyword or Part Number"> <button
 ...
 c0,2.8,2.2,5,5,5c2.8,0,5-2.2,5-5C13,5.2,10.8,3,8,3z" />
                                    ...
                                    <div class="suggestions__group-content"><a
                                            ...
                                            <div class="suggestions__product-image image image--type--product">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-2-40x40.jpg" alt="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="suggestions__product-image image image--type--product">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-3-40x40.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="suggestions__product-info">
                                            ...
                                            <div class="suggestions__product-image image image--type--product">
                                                <div class="image__body"><img class="image__tag"
                                                        src="images/products/product-4-40x40.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="suggestions__product-info">
                ...
                <div class="header__indicators">
                    <div class="indicator"><a href="#" class="indicator__button"><span
        ...
        <ul class="account-menu__links">
         <li><a href="account-login.html">Logout</a></li>
                    ...
                    <div class="indicator indicator--trigger--click"><a href="#"
                            class="indicator__button"><span class="indicator__icon"><svg width="32"
                                    height="32">
 ...
 c-0.6,0-1-0.4-1-1s0.4-1,1-1h15.5c0.8,0,1.5,0.4,2,1c0.5,0.6,0.6,1.5,0.4,2.2l-3.1,10C28.5,20.3,27.5,21,26.4,21z" />
                                ...
                                class="indicator__value">$5902.00</span></a>
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image image image--type--product"><a
                                                class="image__body" href="#"><img class="image__tag"
                                                    src="images/products/product-4-70x70.jpg" alt=""></a>
                                        </div>
                                        ...
                                        </div><button type="button" class="dropcart__item-remove"><svg
                                                width="10" height="10">
 ...
 C9.2,7.8,9.2,8.4,8.8,8.8z" />
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image image image--type--product"><a
                                                class="image__body" href=""><img class="image__tag"
                                                    src="images/products/product-2-70x70.jpg" alt=""></a>
                                        </div>
                                        <div class="dropcart__item-info">
 ...
 C9.2,7.8,9.2,8.4,8.8,8.8z" />
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image image image--type--product"><a
                                                class="image__body" href=""><img class="image__tag"
                                                    src="images/products/product-5-70x70.jpg" alt=""></a>
                                        </div>
                                        <div class="dropcart__item-info">
